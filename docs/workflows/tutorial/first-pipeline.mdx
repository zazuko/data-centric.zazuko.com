...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 5, to: 24 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 26, to: 36 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 38, to: 43 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 45, to: 60 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 62, num: 5 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 69, num: 6 })}
</CodeBlock>
