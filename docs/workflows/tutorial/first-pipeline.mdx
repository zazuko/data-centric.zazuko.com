...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 6, to: 25 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 27, to: 31 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 20, to: 20 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 33, to: 38 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 22, to:22 })}
</CodeBlock>
...
<CodeBlock language="turtle" title="pipeline/main.ttl">
  {selectLines(pipeline, { from: 23, to: 23 })}
</CodeBlock>
